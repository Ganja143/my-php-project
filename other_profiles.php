     ...
     <div class="container-fluid">
         ...
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="float:left;">
            <div class="card text-center bg-secondary ">
                <?php require 'other_data_profile.php'  ?>
                <img class="card-img-top" src="./profile/<?=  $profile   ?>" alt="Title" style="width:20%;height:37vh;margin-left:36%;margin-top:3%;border-radius:180px;">
                <div class="card-body">
                  <h4 class="card-title " style="margin-right:10%;color:white;"><?= $name3 ." ".$surname3   ?></h4>
                  <p class="card-text" style="color:White; margin-right:3%;"><b><?= 'Email Address: '. $user_profile?></b></p>
                </div>
                ...
                <div class="card">
                  ...
                  <div id="section1ContentId" class="collapse in" role="tabpanel" aria-labelledby="section1HeaderId">
                    ...
                    <?php 
                              ...
                              $sql="SELECT * FROM `user profile` WHERE Username='$user_profile'";
                    ...
                    ?>
                              <p class="text-left " style="color:whitesmoke"><b>Postal Address:</b> <?=  $postal_address   ?></p>
                              <p class="text-left"  style="color:whitesmoke"><b>Cellphone number:</b> <?=  $Cell_phone   ?></p>
                      ...
                      ?>
                            <p class="text-left" style="color:whitesmoke"><b>This user did not complete this section</b></p>

                       <?php 
                      
                      } }else{
                        echo '<p class="text-left" style="color:whitesmoke"><b>This user did not complete this section</b></p>';
                      }
                      ?>
                    </div>
                  </div>
                  ...
                  <div id="section2ContentId" class="collapse in" role="tabpanel" aria-labelledby="section2HeaderId">
                    <div class="card-body  bg-secondary">
                      ...
                      ?>
                        ...
                        <p class="text-left" style="color:whitesmoke"><b>Position:</b>Position: <?=  $positon   ?></p>
                        <p  class="text-left" style="color:whitesmoke"><b>Tasks:</b> <?=  $tasks   ?></p>
                        <p  class="text-left"style="color:whitesmoke"><b>Skills:</b> <?=  $skills   ?></p>

                      <?php  }else{    ?>

                        <p class="text-left" style="color:whitesmoke">This section was not completed by user</p>
                  ...
                  <div id="section3ContentId" class="collapse in" role="tabpanel" aria-labelledby="section3HeaderId">
                    <div class="card-body bg-secondary">
                      ...
                      <?php 
                        ...
                        ?>
                           <p class="text-left" style="color:whitesmoke"><b>School:</b> <?=  $school   ?></p>
                          <p  class="text-left" style="color:whitesmoke"><b>Year of Completion:</b> <?=  $year   ?></p>
                          <p  class="text-left"style="color:whitesmoke"><b>Specialty:</b> <?=  $specialty   ?></p>
                          <?php  }else{    ?>   
